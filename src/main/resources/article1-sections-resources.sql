INSERT INTO article_section (id, article_id, section) VALUES (1, 1,
...
<img class="article-img" src="https://devdenise.s3.eu-west-3.amazonaws.com/articles/1/pending-domain-1200x487.jpg">');

INSERT INTO article_section (id, article_id, section) VALUES (2, 1,
...
<img class="article-img" src="https://devdenise.s3.eu-west-3.amazonaws.com/articles/1/initializing-instance-1200x486.jpg">');

INSERT INTO article_section (id, article_id, section) VALUES (3, 1,
...
</p> <img class="article-img" src="https://devdenise.s3.eu-west-3.amazonaws.com/articles/1/elasticIP.JPG">');

INSERT INTO article_section (id, article_id, section) VALUES (4, 1,
...
INSERT INTO article_section (id, article_id, section) VALUES (5, 1,
...
<img class="article-img" src="https://devdenise.s3.eu-west-3.amazonaws.com/articles/1/db.jpg">
<br><br><p>Resources:</p>');
...
INSERT INTO article_resource (id, article_id, resource) VALUES
(1, 1, '<p><a target="_blank" href="https://docs.bitnami.com/aws/how-to/generate-install-lets-encrypt-ssl/">https://docs.bitnami.com/aws/how-to/generate-install-lets-encrypt-ssl/</a></p>'),
(2, 1, '<p><a target="_blank" href="https://docs.bitnami.com/aws/faq/get-started/find-credentials/#option-2-find-password-by-connecting-to-your-application-through-ssh">https://docs.bitnami.com/aws/faq/get-started/find-credentials/#option-2-find-password-by-connecting-to-your-application-through-ssh</a></p>'),
(3, 1, '<p><a target="_blank" href="https://stackoverflow.com/questions/24603620/redirecting-ec2-elastic-load-balancer-from-http-to-https">https://stackoverflow.com/questions/24603620/redirecting-ec2-elastic-load-balancer-from-http-to-https</a></p>'),
(4, 1, '<p><a target="_blank" href="https://stackoverflow.com/questions/46084104/ssl-cloudfront-ec2-wordpress-through-bitnami">https://stackoverflow.com/questions/46084104/ssl-cloudfront-ec2-wordpress-through-bitnami</a></p>'),
(5, 1, '<p><a target="_blank" href="http://coenraets.org/blog/2012/01/setting-up-wordpress-on-amazon-ec2-in-5-minutes/">http://coenraets.org/blog/2012/01/setting-up-wordpress-on-amazon-ec2-in-5-minutes/</a></p>'),
(6, 1, '<p><a target="_blank" href="https://aws.amazon.com/what-is-cloud-computing/#Types_of_cloud_computing">https://aws.amazon.com/what-is-cloud-computing/#Types_of_cloud_computing</a></p>');
